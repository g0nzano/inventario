const SCRIPT_URL =
  "https://script.google.com/macros/s/AKfycbx5KceDniNv-i43v-UfX86vWls9isM0dV9y8iv0ZZRkl9LQKPn6XdFYCBCn7iDktzk/exec";
...
async function loadInventario() {
  ...
  try {
    ...
    if (data.status === "success" && data.data && data.data.length > 0) {
      ...
      tableBody.innerHTML =
        '<tr><td colspan="6">No hay productos en inventario.</td></tr>';
    }
  } catch (error) {
    displayStatus(
      "statusInventario",
